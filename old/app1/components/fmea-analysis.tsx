...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/components/ui/card";ader, CardTitle } from "@/components/ui/card"
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Textarea } from "@/components/ui/textarea";
import { PlusCircle, Save, Trash2, AlertTriangle } from "lucide-react";-react"
import ExpertOpinions, { type Expert } from "./expert-opinions";

// Expertos para esta metodología
const fmeaExperts: Expert[] = [
  {
    id: 1,
        ...
        <CardContent>
                ...
                <tbody>
                  {failureModes.map((mode) => (
                    <tr key={mode.id} className="border-b">
                      ...
                      <td className="p-2">
                        <span className={`px-2 py-1 rounded-full text-xs ${getRpnColor(mode.rpn)}`}>
                          {mode.rpn}
                        </span>
                      </td>
                      <td className="p-2">
          ...
          <div className="mt-6 p-4 border rounded-md bg-yellow-50 border-yellow-200">
            ...
            <ul className="text-xs text-yellow-700 space-y-1">
              <li><span className="inline-block w-16 px-2 py-1 bg-red-100 text-red-800 rounded-full text-center">RPN ≥ 200</span> - Riesgo alto: Requiere acción inmediata</li>
              <li><span className="inline-block w-16 px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-center">RPN ≥ 100</span> - Riesgo medio: Requiere acción planificada</li>
              <li><span className="inline-block w-16 px-2 py-1 bg-green-100 text-green-800 rounded-full text-center\">RPN < 100</span> - Riesgo bajo: Monitorear</li>
            </ul>
          </div>
